            ...
            <form onSubmit={handleSubmit}>
                <label>
                    ...
                    {formData.course === 'Other' && (
                        <input type="text" name="otherCourse" value={formData.otherCourse} onChange={handleChange} placeholder="Enter other course" />
                    )}
                </label>
                <br />
                ...
                <label>
                    ...
                    <select name="societies" value={formData.societies} onChange={(e) => handleCheckboxChange(e, "societies")} multiple>
                        ...
                        <option value="Civil & Environmental Engineering Society ">Civil & Environmental Engineering Society </option>
                        ...
                        <option value="Middle East & North African +">Middle East & North African +</option>
                        ...
                        <option value="Photographers and Models +">Photographers and Models +</option>
